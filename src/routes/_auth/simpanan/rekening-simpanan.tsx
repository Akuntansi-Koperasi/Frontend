...
function RouteComponent() {
  ...
  const [data, setData] = React.useState<Array<RekeningSimpananRecord>>(MOCK_REKENING_SIMPANAN)
  ...
  const filteredData = React.useMemo(() => {
    ...
    const anggotaById = new Map(MOCK_ANGGOTA_OPTIONS.map((anggota) => [anggota.id, anggota.nama]))
    const produkById = new Map(MOCK_PRODUK_SIMPANAN_OPTIONS.map((produk) => [produk.id, produk.nama]))
